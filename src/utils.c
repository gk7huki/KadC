...
long int
millisdiff( struct timespec *pts1, struct timespec *pts2 )
{
...
int
pthread_cond_incrtimedwait( pthread_cond_t *pcond, pthread_mutex_t *pmutex, unsigned long int millisdelay )
{
	struct timespec ts;
	int status;
...
void
pthreadutils_mutex_init_recursive( pthread_mutex_t *pmutex )
{
